...
function selectMethod(
   ...
   * CÔTE D'IVOIRE
   *
   * En CI, on affiche le receiver
   * même si le template USSD est vide.
   *
   * Le numéro vient exclusivement
  ...
  if (
     ...
     * AUTRES PAYS
     *
     * Le receiver est affiché uniquement
     * si le template demande {receiver}.
     *
     * Exemple BF Moov :
     ...
     * *144*4*6*{amount}#
     *
     * Donc BF Orange n'affiche pas le receiver.
     * =====================================================
     */
...
function updateUSSD() {
  ...
  /*
   * =======================================================
   * PAS DE TEMPLATE USSD
   *
   * Le receiver CI peut quand même être affiché.
   * =======================================================
   */
   ...
   * RECEVEUR
   *
   * Utilise exclusivement celui
   * retourné par la base.
   * =======================================================
   */
