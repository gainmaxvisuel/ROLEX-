...
function showTelegram() {
  ...
  /*
    On supprime le signal après
    ouverture du popup.

    Un simple rafraîchissement du
    dashboard ne fera donc pas
    réapparaître le popup.
  */
...
if (laterTelegram) {
  ...
  laterTelegram.addEventListener(
    "click",
    () => {
